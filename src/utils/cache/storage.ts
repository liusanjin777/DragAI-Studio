...
export const getStorage = (key: string, flag: boolean = true) => {
...
export const removeStorage = (key: string, flag: boolean = true) => {
  flag ? localStorage.removeItem(key) : sessionStorage.removeItem(key)
}

export const clearStorage = (flag: boolean = true) => {
