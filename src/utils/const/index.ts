...
export const NODE_TYPE_START = 'DRAGAI_START'
export const NODE_TYPE_END = 'DRAGAI_END'
export const NODE_TYPE_INTERMEDIATE_END = 'DRAGAI_INTERMEDIATE_END'

export const DRAGAI_EDGE = 'DRAGAI_EDGE'
export const DRAGAI_ANCHOR = 'liuxin'
export const DRAGAI_ROUTER = 'DRAGAI_ROUTER'
